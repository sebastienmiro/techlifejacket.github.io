...
Je vous livre dans cet article un bref résumé traduit en français du rapport de l'[ENISA](https://www.enisa.europa.eu/) traitant des menaces de typer ransowmware. Le rapport complet est [téléchargeable ici](https://www.enisa.europa.eu/publications/enisa-threat-landscape-for-ransomware-attacks/@@download/fullReport)
...
Certains MSP, à leur tour, ont été exploités pour déployer des logiciels malveillants et des rançongiciels chez leurs clients._
